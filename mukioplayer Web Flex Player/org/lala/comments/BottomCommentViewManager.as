package org.lala.comments 
{
	 ...
	 * @author 
	 */
	public class BottomCommentViewManager extends EventDispatcher
	{
		...
		public function BottomCommentViewManager(cv:CommentView,gtr:CommentGetter,cftr:CommentFilter) :void
		{
			cview = cv;
...
///////////////////////////
				a.txtItem.y = Height-(y % Height)-a.txtItem.height;
///////////////////////////				
				a.y = y;
...
//			var self:CommentViewManager= this;
			var self:BottomCommentViewManager= this;
